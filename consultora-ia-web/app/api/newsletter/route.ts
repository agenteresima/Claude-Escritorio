...
export async function POST(request: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to: email,
      subject: '¡Bienvenido/a a la newsletter de Nexus IA! 🚀',
      html: `
        <!DOCTYPE html>
        <html lang="es">
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:12px; overflow:hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.07);">
                <tr>
                  <td style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 40px; text-align: center;">
                    <h1 style="color:#ffffff; margin:0; font-size:28px; font-weight:700;">Nexus IA</h1>
                ...
                <tr>
                  <td style="padding: 40px;">
                    ...
                    <p style="color:#374151; line-height:1.7; margin: 0 0 16px; font-size:15px;">Gracias por suscribirte a la newsletter de Nexus IA. Cada semana recibirás:</p>
                    <ul style="color:#374151; line-height:1.8; font-size:15px; padding-left: 20px;">
                      ...
                      <li>Novedades exclusivas de Nexus IA</li>
                    </ul>
                    <table cellpadding="0" cellspacing="0" style="margin: 32px auto;">
                      <tr>
                        <td style="background-color:#1e40af; border-radius:8px; padding: 14px 28px;">
                          <a href="https://nexusia.es/blog" style="color:#ffffff; text-decoration:none; font-weight:600; font-size:15px;">Leer el blog →</a>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="background-color:#f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
                    <p style="color:#9ca3af; font-size:11px; margin:0; line-height:1.6; text-align: center;">
                      ...
                      Has recibido este email porque te suscribiste en <a href="https://nexusia.es" style="color:#9ca3af;">nexusia.es</a><br><br>
                      Si no deseas recibir más emails, <a href="https://nexusia.es/baja-newsletter?email=${encodeURIComponent(email)}" style="color:#9ca3af;">cancela tu suscripción aquí</a>.<br>
