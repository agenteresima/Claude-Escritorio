...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/agentes-ia`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/automatizacion-procesos`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/auditoria-ia`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/casos-uso`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  ]
