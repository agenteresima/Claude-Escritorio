...
const STEPS: Record<StepId, BotStep> = {
  welcome: {
    id: 'welcome',
    message: '¡Hola! 👋 Soy el asistente de Nexus IA. ¿En qué puedo ayudarte hoy?',
    options: [
  ...
  qualification: {
    id: 'qualification',
    message:
      'Gracias, esto me ayuda mucho a entenderte mejor. ¿Te gustaría que un consultor de Nexus IA te contactara para una videollamada gratuita de 45 minutos?',
  ...
  confirmed: {
    id: 'confirmed',
    message:
      '¡Listo! 🎉 He registrado tu solicitud. Un consultor de Nexus IA se pondrá en contacto contigo en menos de 24 horas laborables. Mientras tanto, puedes explorar nuestros servicios o leer nuestro blog.',
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-blue-600 text-white flex-shrink-0">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="font-semibold text-sm leading-tight">Nexus IA · Asistente</p>
              ...
              <div className="flex-shrink-0 border-t border-gray-100 bg-white px-3 py-3">
                ...
                <p className="text-center text-xs text-gray-400 mt-2">
                  Nexus IA · Tus datos están protegidos según el RGPD
                </p>
              </div>
            </motion.div>
          )}
